...
const calculator =() =>
{
  ...
  function getgrade(item)
  {
   if(item<40 && item>=0)
    ...
    else if((mark1>100||mark1<0)||(mark2>100||mark2<0)||(mark3>100||mark3<0)||(mark4>100||mark4<0)||(mark5>100||mark5<0))
    {
    ...
    mark3=credit8*getgrade(mark3);
    mark4=credit1*getgrade(mark4);
