...
const calculator =() =>
{
  ...
  function getgrade(item)
  {
   if(item<40 && item>=0)
    ...
    else if((mark1>100||mark1<0)||(mark2>100||mark2<0)||(mark3>100||mark3<0)||(mark4>100||mark4<0)||(mark5>100||mark5<0)||(mark6>100||mark6<0)||(mark7>100||mark7<0)||(mark8>100||mark8<0)||(mark9>100||mark9<0))
    {
