...
const calculator =() =>
{
  ...
  function getgrade(item)
  {
   if(item<40 && item>=0)
    ...
    if((mark1=="")||(mark2=="")||(mark3=="")||(mark4=="")||(mark5=="")||(mark6=="")||(mark7==""))
    {
        alert("Please fill out all fields");
    }
    else if((mark1>100||mark1<0)||(mark2>100||mark2<0)||(mark3>100||mark3<0)||(mark4>100||mark4<0)||(mark5>100||mark5<0)||(mark6>100||mark6<0)||(mark7>100||mark7<0))
    {
         alert("Please enter values between 0 to 100");
    }
    else
    {
    mark1=credit4*getgrade(mark1);
    mark2=credit4*getgrade(mark2);
